...
// All Pages - Globals
// --------------------------------------------------------------------------------------------------
$accessErrorHeader			= "Դիմելու սխալ";
$permissionDenied			= "Դուք չեք կարող տեսնել այս էջը։";
$pageNotFoundHeader			= "Page Not Found &mdash; 404 Error";
$pageNotFoundQuip			= "Էջը չի գտնվել։";
$thankYouText				= "Շնորհակալություն,";
...
$yesBtn						= "Այո";
$noBtn						= "Ոչ";
$saveChangesBtn				= "Հիշել փոփոխությունները";
$saveBtn					= "Հիշել";
$deleteBtn					= "Ջնջել";
$updateBtn					= "Թարմացնել";
$selectOption				= "Ընտրել...";

$taskedLogoAltText			= "Ռոստելեկոմ Գրություններ";
$passwordsNotMatchMsg		= "Գաղտնաբառերը չեն համընկնում։ Խնդրում ենք ստուգել։";

$loginNavLink				= "Մուտք";
$createAccNavLink			= "Ստեղծել օգտատեր";
$resetPassNavLink			= "Փոխել գաղտնաբառը";

// Calendar Include File
// --------------------------------------------------------------------------------------------------
$todayLink					= "Այսօր";
$newEventLink				= "Նոր միջոցառում";
$monthLink					= "Ամիս";
$weekLink					= "Շաբաթ";
$dayLink					= "Օր";
...
$editEvent					= "Խմբագրել";
$deleteEvent				= "Հեռացնել";

// Activate Account
// --------------------------------------------------------------------------------------------------
$activatePageTitle			= "Ակտիվացում";
$activateText1				= "Շնորհակալություն Ձեր Էլ․հասցեն հաստատելու և Ձեր ակաունտն ակտիվացնելու համար։";
$activateText2				= "Ձեր ականունտն արդեն ակտիվ և կարող եք մուտք գործել։";
...
$loginPageQuip				= " ";//"Enter your ".$set['siteName']." account information and click Sign In.";
$emailAddyField				= "Email հասցե";
$emailAddyFieldHelp			= "A Valid Email Address. Your Email Address is also used to log in.";
$passwordField				= "Գաղտնաբառ";
$passwordFieldHelp1			= "Choose a password for your new account.";
$repeatText					= "Կրկնել";
$repeatPassHelp				= "Կրկնել գաղտնաբառը։ Գաղտնաբառերը պետք է համընկնեն։";
$signInBtn					= "Մուտք";
$createAccountTitle			= "Create Account";
$createAccountQuip			= "Register a New ".$set['siteName']." Account.";
$firstNameField				= "Անուն";
$lastNameField				= "Ազգանուն";
$captchaCodeField			= "Captcha Code";
$createAccountBtn			= "Create My Account";
$resetPasswordTitle			= "Reset Password";
$resetPasswordQuip			= "Փոխել ".$set['siteName']." համակարգում Ձեր գաղտնաբառը";
...
$resetPassEmailTitle		= "Your ".$set['siteName']." Password has been Reset";
...
// New Account Email
$newAccountEmailSubject		= "Ձեր ".$set['siteName']." Ակաունտն ստեղծվել է։";
$newAccountEmail1			= "Տվյալներն են՝ ";
$newAccountEmail2			= "Username: Ձեր էլ․ հասցեն<br>Գաղտնաբառ՝";
...
// Header Include
// --------------------------------------------------------------------------------------------------
$headerIncTitle				= "Ընկերության անվանում - գրություններ";

// Footer Include
// --------------------------------------------------------------------------------------------------
$recentActivityTitle		= "Վերջին գործողությունները";
$activeCategoriesTitle		= "Ակտիվ կատեգորիաներ";
$copyrightText				= "Copyright";

// Navigation Include
// --------------------------------------------------------------------------------------------------
$profileNavLink				= "Պրոֆիլ";
$signOutNavLink				= "Դուրս գալ";
$dashboardNavLink			= "Գլխավոր";
$calendarNavLink			= "Օրացույց";
$tasksNavLink				= "Գրություններ";
$openTasksNavLink			= "Բոլոր գրությունները";
$closedTasksNavLink			= "Ավարտված գրությունները";
$newTaskNavLink				= "Նոր գրություն";
$catsNavLink				= "Կատեգորիա";
$catListNavLink				= "Կատեգորիաներ";
$newCatNavLink				= "Նոր կատեգորիա";
$usersNavLink				= "Օգտագործողներ";
$userListNavLink			= "Ցանկ";
$newUserNavLink				= "Նոր օգտագործող";
$siteSettingsNavLink		= "Կարգավորումներ";
$signOutQuip				= ", դուք ցանկանում եք դու՞րս գալ։";
$signOutBtn					= "Դուրս գալ";
$searchTooltip				= "Որոնում";
$searchPlaceholder			= "Մուտքագրել որոնվող բառը";
$addNewTaskModal			= "Ավելացնել նոր գրություն";
$addNewTaskQuip				= "Նախ անհրաժեշտ է ստեղծել համապատասխան կատեգորիա։";
$taskTitleField				= "Գրության անվանում";
$taskTitleHelp				= "Գրության հակիրճ անվանում";
$categoryField				= "Ում կողմից";
$categoryHelp				= "Ընտրել կատեգորիա տվյալ գրության համար։";
$priorityField				= "Կարևորություն";
$assignField				= "Ընթացք";
$whatotdoField	            = "Ի՞նչ անել";
$deadlineField	            = "Վերջնաժամկետ";

$priorityHelp				= " ";
$statusField				= "Հերթական համար";
$statusHelp					= " ";
$perentCompField			= "Պատասխան գրության համար";
$perentCompHelp				= "Միայն թվեր";
$startDateField				= "Գրության ուղարկման ամսաթիվը";
$dueDateField				= "Գրության ստացման ամսաթիվը";
$taskDescField				= "Այլ նշումներ";
$addToCalCheckbox			= "Ավելացնել օրացույցում";
$addToCalHelp				= " ";//"Checking this option will add the task to your calendar on the Task's Due Date.";
$newCatModal				= "Ավելացնել նոր կատեգորիա";
$catNameField				= "Անվանումը";
$catNameHelp				= " ";//"Give the New Category a Short Name";
$catDescField				= "Նկարագրություն";
...
$generatePassTooltip		= "Գեներացնել գաղտնաբառ";
...
$taskTitleReq				= "Գրության բովանդակաությունը պարտադիր է։";
$taskCatReq					= "Գրության կատեգորիան պարտադիր է։";
$taskPriorityReq			= "Կարևորության դաշտը պարտադիր է։";
$taskStatusReq				= "Հ/Հ - դաշտը պարտադիր է։";
$taskPercentCompReq			= "The Task Percent Complete is required.";
$taskStartDateReq			= "Ուղարկման ամսաթիվը պարտադիր է։";
$taskDueDateReq				= "Ստացման ամսաթիվը պարտադիր է։";
$taskDescReq				= "Այլ նշումնրը պարտադիր դաշտ է։";
$taskedSavedMsg1			= "Նոր գրությունն ստեղծվել է և ավելացվել է օրացույցում";
$taskedSavedMsg2			= "Նոր գրությունը պահպանված է։";
$catNameReq					= "Կատեգորիա անվանումը պարտադիր է։";
$catDescReq					= "Կատեգորիաի նկարագրությունը պարտադիր է։";
$newCatSavedMsg				= "Նոր կատեգորիան պահպանված է։";
...
// New User Email
$newUserEmailSubject		= "Ձեր ".$set['siteName']." Account has been created";
...
$newTaskTooltip				= "Նոր գրություն";
$newCatTooltip				= "Նոր կատեգորիա";
$noOpenTasks				= "Բաց գրություններ չեն գտնվել։";
$noteText					= "Նշում";
$notesText					= "Նշումներ";
$viewTaskTooltip			= "Տեսնել գրությունը";
$viewCatTooltip				= "Տեսնել կատեգորիան";
$percCompleteText			= "կատարված է %";
$percentSymbol				= "Ընթացք";
$completeTooltip			= "Կատարված";
$editTooltip				= "Խմբագրել";
$deleteTooltip				= "Ջնջել";
$completeTaskQuip1			= "Նշել գրությունը";
$completeTaskQuip2			= "որպես փակվա՞ծ/ավարտվա՞ծ";
$deleteTaskQuip				= "Ջնջե՞լ գրությունը։";
$upcomingDatesTitle			= "Մոտակա ամսաթվեր";
$noUpcomingDatesMsg			= "Ոչինչ չի գտնվել։";
...
$taskText					= "Գրություն";
$tasksText					= "Գրություններ";
$categoryText				= "Կատեգորիա";
$categoriesText				= "Կատեգորիաներ";
$dateText					= "Date";
$datesText					= "Dates";
$openTasksToggle			= "Բացել բոլոր գրությունները";
$closeTasksToggle			= "Փակել բոլոր գրությունները";
...
// Open Tasks
// --------------------------------------------------------------------------------------------------
$taskTitleTH				= "Անվանում";
$taskCatTH					= "Կատեգորիա";
$priorityTH					= "Կարևորություն";
$statusTH					= "Հ/Հ";
$taskCompErrorMsg			= "Տեղի է ունեցել սխալ։ Գրությունը հնարավոր չէ նշել որպես ավարտված։";
$taskDeleteErrorMsg			= "Տեղի է ունեցել սխալ։ Գրությունը հնարավոր չէ ջնջել։";

// Closed Tasks
// --------------------------------------------------------------------------------------------------
$noClosedTasksMsg			= "Ավարտված գրություններ չկան";
$dateClosedTH				= "Date Closed";
$reopenTaskText				= "Վերաբացել";
$reopenTaskQuip				= "Վերաացել գրությունը";
$taskReopenedMsg			= "Գրությունը վերաբացված է։";
$taskReopenErrorMsg			= "Տեղի է ունեցել սխալ։ Գրությունը հնարավոր չէ վերաբացել։";

// View Tasks
// --------------------------------------------------------------------------------------------------
$taskNotesText				= "Նշումներ";
$reopenTaskBtn				= "Վերաբացել գրությունը";
$completeTaskBtn			= "Ավարտել գրությունը";
$taskClosedMsg				= "This Task has been completed/closed.";
$taskDetailsText			= "Գրության մանրամասներ";
$titleText					= "Բովանդակություն։";
$descText					= "Այլ նշումներ";
$taskSettingsTitle			= "Կարգավորումներ";
$taskDatesTitle				= "Ամսաթվեր";
$dateDueField				= "Ստացման ամսաթիվը";
$dateClosedField			= "Date Closed";
$noNotesMsg					= "Ուրիշ այլ նշումներ չկան։";
$editNoteModal				= "Edit Note";
$deleteNoteQuip				= "Are you sure you want to permanently DELETE this note?";
$addNoteTitle				= "Ավելացնել նշում";
...
// Categories List
// --------------------------------------------------------------------------------------------------
$descTH						= "Նկարագրություն";
$dateCreatedTH				= "Ստեղծման ամսաթիվը";
$activeText					= "Ակտիվ";
$inactiveText				= "Ոչ ակտիվ";
$deleteCatQuip1				= "Are you sure you want to permanently DELETE the Category";
$deleteCatQuip2				= "Այս գործողությունը անվերադարձ կջնջի կատեգորիան և նրա հետ կապված բոլոր գրությունները";
...
// View Category
// --------------------------------------------------------------------------------------------------
$editCatTooltip				= "Խմբագրել կատեգորիան";
$lastUpdatedText			= "Վերջին թարմացումը";
...
$newPassField				= "Նոր գաղտնաբառ";
$clearFieldsText			= "Մաքրել դաշտերը";
...
$siteNameHelp				= "Appears in the Footer and other various locations throughout Tasked.";
...
// Profile
// --------------------------------------------------------------------------------------------------
$profilePageTitle			= "Իմ պրոֆիլը";
$profileDetailsTitle		= "Պրոֆիլի մանրամասներ";
...
$currentText				= "Ընթացիկ";
$currentPasswordHelp		= "Ձեր ընթացիկ գաղտնաբառը";
